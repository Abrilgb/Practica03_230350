...
app.use(session({
    secret: 'p3-AGB#-yinyerina-sesionespersistentes', // Secreto para firmar la cookie
    ...
    cookie: { secure: false, maxAge: 24 * 60 * 60 * 1000 } //Usar secure:true solo si usas HTTPS, maxage para la duracin
}));
